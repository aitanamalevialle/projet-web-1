<?php
    ...
    class Validation {
        ...
        // Méthode pour définir la propriété.
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'La valeur du champ '.$this->name.' est inférieure à la valeur minimale.';
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'La valeur du champ '.$this->name.' est supérieure à la valeur maximale.';
                }
